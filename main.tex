...
Соответсвенно, при вращении пары дебалансов точка центра масс будет отличной от системы, где дебаланс вращался лишь один дебаланс (рис \ref{fig:double_debalance}).
